...
namespace WebCineflex.Controllers
{
    public class PeliculasController : Controller
    {
        ...
        public PeliculasController(UsuariosCineflexContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Peliculas != null ? 
                          ...
                          Problem("Entity set 'UsuariosCineflexContext.Peliculas'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'UsuariosCineflexContext.Peliculas'  is null.");
            }
            var pelicula = await _context.Peliculas.FindAsync(id);
            if (pelicula != null)
            {
